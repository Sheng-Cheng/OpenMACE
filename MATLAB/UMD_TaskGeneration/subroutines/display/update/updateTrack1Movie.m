function plotHandles  = updateTrack1Movie( swarmWorld, swarmState, targetState, trueWorld, runParams, swarmModel, targetModel, plotHandles)
...
if ( ~isempty(swarmWorld.activeTrackerInd) )
    ...
    ind1 = swarmWorld.activeTrackerInd(1);
