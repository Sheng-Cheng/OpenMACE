function plotHandles  = updateTrack2Movie( swarmWorld, swarmState, targetState, trueWorld, runParams, swarmModel, targetModel, plotHandles)
...
if ( length(swarmWorld.activeTrackerInd) >= 2 )
    ...
    ind1 = swarmWorld.activeTrackerInd(2);
    plotHandles.p1.NodeCData = swarmWorld.tracker{ind1}.log_likelihood_env;
