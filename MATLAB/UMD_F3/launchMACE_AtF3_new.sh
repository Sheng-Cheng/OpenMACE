...
# - $MACE_ROOT 
# - $ARDUPILOT_ROOT
# Note: This script uses the USB mappings defined in /etc/udev/rules.d/10-usb-serial.rules

package="launchMACE_AtF3_new"
cwd=$(pwd)
...
<Parameter Name=\"SerialParameters\">
     <Parameter Name=\"PortName\">ttyUSB_drone${REAL_AGENT_ID[$i]}</Parameter>
